...
| Actually initialized model  | `gpt-5.6-luna`                       |
| Actually initialized effort | `max` (`model_reasoning_effort=max`) |
| Fallback                    | None                                 |

The requested and actual values were verified from the live Codex process command line.
No model fallback was selected.
