...
> CI scripts and the workflow are the release gate. See the [verification guide](../verification.md).
...
provisioning. Compose passwords, sample owners, and sample properties are development
fixtures only.
