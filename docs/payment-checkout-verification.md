...
## Production activation — Adam-blocked

Production activation is intentionally blocked because the repository does not contain the
inputs needed to make that decision safely. Adam must provide and approve all of the
following before a production adapter or deployment is considered:
