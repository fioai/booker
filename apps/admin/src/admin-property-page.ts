export interface AdminPropertyPageInputV1 {
  readonly property: {
    readonly id: string;
...
export function renderAdminPropertyPageV1(input: AdminPropertyPageInputV1): string {
...
export const renderAdminPropertyPage = renderAdminPropertyPageV1;
