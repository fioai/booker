import type { PropertyConfigurationInputV1 } from '../src/index.js';

export const sampleBungalowFixture: PropertyConfigurationInputV1 = {
  id: 'sample-bungalow',
...
export const syntheticHarbourLoftFixture: PropertyConfigurationInputV1 = {
  id: 'harbour-loft-ca',
  name: 'Harbour Loft',
