...
export type OwnerRoleV1 = 'owner' | 'admin' | 'manager' | 'viewer';

export interface OwnerCredentialRecordV1 {
  readonly id: string;
  readonly organizationId: string;
  readonly email: string;
  readonly role: OwnerRoleV1;
  readonly passwordHash: string;
}

export interface OwnerCredentialRepositoryV1 {
  findByEmail(email: string): Promise<OwnerCredentialRecordV1 | null>;
  create(input: OwnerCredentialRecordV1): Promise<OwnerCredentialRecordV1>;
...
function role(value: unknown): OwnerRoleV1 {
...
function mapRow(row: OwnerCredentialRow): OwnerCredentialRecordV1 {
  if (
...
function validateInput(input: OwnerCredentialRecordV1): OwnerCredentialRecordV1 {
...
export class PostgresOwnerCredentialRepository implements OwnerCredentialRepositoryV1 {
  ...
  async findByEmail(value: string): Promise<OwnerCredentialRecordV1 | null> {
  ...
  async create(input: OwnerCredentialRecordV1): Promise<OwnerCredentialRecordV1> {
